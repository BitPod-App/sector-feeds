...
OUT_DIR="/Users/cjarguello/bitpod-app/sector-feeds/transcripts/jack_mallers_show/compare"
STAMP="$(date -u +%Y%m%dT%H%M%SZ)"
mkdir -p "$OUT_DIR" /Users/cjarguello/bitpod-app/sector-feeds/cache/compare/youtube /Users/cjarguello/bitpod-app/sector-feeds/cache/compare/anchor/chunks
...
video_url = "https://www.youtube.com/watch?v=BFt82dw0ci8"
out = Path("/Users/cjarguello/bitpod-app/sector-feeds/transcripts/jack_mallers_show/compare")
stamp = Path('/tmp/bitpod_stamp').read_text().strip()
work = Path("/Users/cjarguello/bitpod-app/sector-feeds/cache/compare/youtube")
...
curl -L --fail --silent --show-error "$ANCHOR_MP3" -o "/Users/cjarguello/bitpod-app/sector-feeds/cache/compare/anchor/${STAMP}_anchor.mp3"

# split to API-safe chunks (8 minutes each)
ffmpeg -hide_banner -loglevel error -y \
  -i "/Users/cjarguello/bitpod-app/sector-feeds/cache/compare/anchor/${STAMP}_anchor.mp3" \
  -f segment -segment_time 480 -c copy \
  "/Users/cjarguello/bitpod-app/sector-feeds/cache/compare/anchor/chunks/${STAMP}_%03d.mp3"
...
out = Path("/Users/cjarguello/bitpod-app/sector-feeds/transcripts/jack_mallers_show/compare")
stamp = Path('/tmp/bitpod_stamp').read_text().strip()
chunk_dir = Path("/Users/cjarguello/bitpod-app/sector-feeds/cache/compare/anchor/chunks")
