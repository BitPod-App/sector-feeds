...
BITREGIME_ROOT="${BITREGIME_ROOT:-$WORKSPACE_ROOT/bitregime-core}"
...
cmd_render_experimental() {
  ...
  local output_gate="$BITREGIME_ROOT/artifacts/gates/weekly_bundle_gate_status.json"
  ...
  python3 "$BITREGIME_ROOT/scripts/gate_weekly_bundle.py" \
