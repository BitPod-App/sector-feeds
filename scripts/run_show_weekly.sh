...
print(f"transcript_provenance={payload.get('transcript_provenance')}")
print(f"gpt_review_request_path={payload.get('gpt_review_request_path')}")
print(f"gpt_review_artifact_path={payload.get('gpt_review_artifact_path')}")
